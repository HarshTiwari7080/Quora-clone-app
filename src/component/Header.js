...
//import './App.css'; // Assuming you have some additional CSS for custom styles

const Header = () => {
    return (
        <div className="col-md-5 mx-auto">
            <div className="create-post card p-3 mb-7">
            ...
            <div className="post card p-3 mb-4">
                ...
                <img src="images/sudha murthy.png" className="img-fluid" alt="Post content" />
